...
<div class="close"><a href="http://localhost/novosdialogos/"><span aria-hidden="true">&times;</span></a></div>
<!--onClick="window.location = 'http://localhost/novosdialogos/'; window.location.reload(true);"-->
