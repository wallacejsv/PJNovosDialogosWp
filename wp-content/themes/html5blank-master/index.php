...
<div class="loader-imagem"><center><img class="loader-imagem" src="http://localhost/novosdialogos/wp-content/uploads/2015/04/loading-1.gif"/></center></div>
</div>
...
<!--<a onclick="history.pushState('teste','Titulo de teste','http://localhost/novosdialogos/alex-teste/'); return false;" title="UpInside Tecnologia" id="Ola" href="http://localhost/novosdialogos/alex-teste/" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://localhost/novosdialogos/alex-teste/']);" rel="shadowbox">UpInside</a>-->  
